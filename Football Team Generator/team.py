...
player1 = Player("John Doe", 85, 90, 88, 92, 87)
player2 = Player("Jane Smith", 80, 85, 89, 91, 88)

team = Team("Dream Team", 5)
print(team.add_player(player1))  
print(team.add_player(player1))  
print(team.add_player(player2))  

print(team.remove_player("John Doe"))  
print(team.remove_player("Nonexistent Player"))  
